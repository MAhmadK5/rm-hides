  ...
  return (
    <footer className="relative w-full bg-[#020000] pt-32 pb-10 border-t-2 border-[#7a0016] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Middle: Links & Social Icons */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-24 text-sm font-light text-white/50">
          ...
          {/* UPDATED: Support Links point to your new pages */}
          <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-5">
              <a href="https://www.instagram.com/rmhides/" className="text-white/50 hover:text-[#7a0016] transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.pinterest.com/rmhides/" className="text-white/50 hover:text-[#7a0016] transition-colors" aria-label="Pinterest">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[#7a0016]/30 text-[10px] uppercase tracking-[0.2em] text-white/40 gap-6">
          ...
          <div className="flex items-center gap-4 order-1 md:order-2">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/in/m-ahmad-khalid-bb0514377/" className="hover:text-[#7a0016] transition-colors" aria-label="LinkedIn">
              ...
              <a href="https://github.com/MAhmadK5" className="hover:text-[#7a0016] transition-colors" aria-label="GitHub">
